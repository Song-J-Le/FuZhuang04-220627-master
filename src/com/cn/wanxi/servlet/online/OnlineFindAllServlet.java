...
@WebServlet("/back/online/findAll")
public class OnlineFindAllServlet extends HttpServlet {
    @Override
...
//       5.得到返回的数据
        ResultModel result = onlineService.findAll(onlineModel);
//        返回页面
//        req.setAttribute("result", result);
//        req.getRequestDispatcher("/jsp/oneline.jsp").forward(req, resp);
//       6. 那么我们怎么给前端一个信息，提示信息
